        ...
        <div className="banner-cont">
            <div className="banner-left-cont">
              <div className="banner-information">
                  ...
                  <span>
                  Enjoy a healthy life by eating helathy foods that <br /> have
                  extraordinary flavors that make your life <br /> healthier for today
                  and in the future
                  </span>
            ...
            <img src={BannerImage} alt="BannerImage" style={{ filter: "drop-shadow(0 0 0.75rem crimson)" }} />
            </div>
        </div>
