...
function AllPlans({ props }) {
  ...
  return (
    ...
    >
      <div className="top-plan-part w-75 d-flex justify-content-evenly align-items-center" style={{position : 'relative'}}>
        <h2 style={{ color: "rgb(92,181,72)" }}>All Plans </h2>
        <div className="admin-filtered-option d-flex align-self-end" onClick={() => setDisplay(!display)} style={{cursor : 'pointer', border : '1px solid white', padding : '0.6rem', color : 'white'}}>
          Filters
        <MoreVertIcon />
        </div>
      </div>
