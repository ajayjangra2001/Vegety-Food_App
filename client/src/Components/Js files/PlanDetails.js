...
import planDetailsImage from "../../Images/topPlan.jpg";
        ...
        {reviewsDetails !== null ? (
          <>
            {reviewsDetails.map((review) => (
              <div className="user-comment-container p-3 mt-4">
                <div className="comment-box-top-part d-flex">
                  ...
                  <div
                    className="comment-box-right-part d-flex justify-content-center flex-column"
                    style={{
                      marginLeft: "1rem",
                      lineHeight: "0.5rem",
                      padding: "0.5rem 0",
                ...
                <div className="comment-box-bottom-part mt-2">
